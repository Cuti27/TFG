export default {
    ...
    loadAnalogicalOutput(state, value) {
        state.configureDeviceOutputInput.analogicalOutput = value.listAnalogicalOutput;
    },
    loadAnalogicalInput(state, value) {
        state.configureDeviceOutputInput.analogicalInput = value.listAnalogicalInput;
    },
