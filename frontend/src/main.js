...
import { faSignInAlt, faHome, faInfoCircle, faTrashAlt, faCheck, faPlusSquare, faPlusCircle, faWrench, faArrowsAltH, faFaucet, faLeaf, faArrowCircleLeft, faArrowCircleRight } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/vue-fontawesome'
import VueTour from 'vue-tour';

require('vue-tour/dist/vue-tour.css')

library.add(faSignInAlt, faHome, faInfoCircle, faTrashAlt, faCheck, faPlusSquare, faLinkedinIn, faFacebookF, faPlusCircle, faWrench, faArrowsAltH, faFaucet, faLeaf, faArrowCircleLeft, faArrowCircleRight);
